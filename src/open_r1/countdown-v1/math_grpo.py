...
def main(script_args, training_args, model_args):
    ...
    def process_dataset(example):
        ...
        problem = f"Using the numbers {nums}, create an equation that equals {target}. You can use basic arithmetic operations (+, -, *, /) and each number can only be used once. Show your work in <think> </think> tags, and return the final answer in <answer> </answer> tags."
        ground_truth = {
            "target": target,
            "numbers": nums
        }
        return {"problem": problem , "ground_truth": ground_truth}
